...
const GRANT_ITEMS: Record<string, GrantItem> = {
  ...
  CROWN_DAY_90: { kind: 'lottery', label: '一日冠9折券', prizeName: PRIZE_NAMES.CROWN_DAY_90_VOUCHER },
  CROWN_3DAY_90: { kind: 'lottery', label: '三日冠9折券', prizeName: PRIZE_NAMES.CROWN_3DAY_90_VOUCHER },
  CROWN_WEEK_90: { kind: 'lottery', label: '一周冠9折券', prizeName: PRIZE_NAMES.CROWN_WEEK_90_VOUCHER },
  CROWN_MONTH_90: { kind: 'lottery', label: '月冠名9折券', prizeName: PRIZE_NAMES.CROWN_MONTH_90_VOUCHER },
