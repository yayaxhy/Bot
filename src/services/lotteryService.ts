...
const PRIZE_NAME_BY_KIND: Record<PrizeKind, string | null> = {
  ...
  CROWN_DAY_95_VOUCHER: PRIZE_NAMES.CROWN_DAY_95_VOUCHER,
  CROWN_DAY_92_VOUCHER: PRIZE_NAMES.CROWN_DAY_92_VOUCHER,
  CROWN_75_VOUCHER: PRIZE_NAMES.CROWN_75_VOUCHER,
  CROWN_DAY_90_VOUCHER: PRIZE_NAMES.CROWN_DAY_90_VOUCHER,
  CROWN_3DAY_92_VOUCHER: PRIZE_NAMES.CROWN_3DAY_92_VOUCHER,
  CROWN_3DAY_90_VOUCHER: PRIZE_NAMES.CROWN_3DAY_90_VOUCHER,
  CROWN_WEEK_92_VOUCHER: PRIZE_NAMES.CROWN_WEEK_92_VOUCHER,
  CROWN_WEEK_90_VOUCHER: PRIZE_NAMES.CROWN_WEEK_90_VOUCHER,
  CROWN_MONTH_92_VOUCHER: PRIZE_NAMES.CROWN_MONTH_92_VOUCHER,
...
export type PrizeKind =
  ...
  | 'PUMPKIN_CAR_VOUCHER'
  | 'PHONOGRAPH_VOUCHER'
  | 'CROWN_DAY_95_VOUCHER'
  | 'CROWN_DAY_92_VOUCHER'
  | 'CROWN_75_VOUCHER'
  | 'CROWN_DAY_90_VOUCHER'
  | 'CROWN_3DAY_92_VOUCHER'
  | 'CROWN_3DAY_90_VOUCHER'
  | 'CROWN_WEEK_92_VOUCHER'
  | 'CROWN_WEEK_90_VOUCHER'
  | 'CROWN_MONTH_92_VOUCHER'
...
export function classifyPrize(prizeName?: string | null): PrizeKind {
  ...
  switch (normalized) {
    ...
    case PRIZE_NAMES.CROWN_DAY_95_VOUCHER:
      return 'CROWN_DAY_95_VOUCHER';
    case PRIZE_NAMES.CROWN_DAY_92_VOUCHER:
      return 'CROWN_DAY_92_VOUCHER';
    case PRIZE_NAMES.CROWN_75_VOUCHER:
      return 'CROWN_75_VOUCHER';
    case PRIZE_NAMES.CROWN_DAY_90_VOUCHER:
      return 'CROWN_DAY_90_VOUCHER';
    case PRIZE_NAMES.CROWN_3DAY_92_VOUCHER:
      return 'CROWN_3DAY_92_VOUCHER';
    case PRIZE_NAMES.CROWN_3DAY_90_VOUCHER:
      return 'CROWN_3DAY_90_VOUCHER';
    case PRIZE_NAMES.CROWN_WEEK_92_VOUCHER:
      return 'CROWN_WEEK_92_VOUCHER';
    case PRIZE_NAMES.CROWN_WEEK_90_VOUCHER:
      return 'CROWN_WEEK_90_VOUCHER';
    case PRIZE_NAMES.CROWN_MONTH_92_VOUCHER:
      return 'CROWN_MONTH_92_VOUCHER';
...
const generateCode = (kind: PrizeKind): string => {
  const prefixMap: Record<PrizeKind, string> = {
    ...
    CROWN_DAY_95_VOUCHER: 'CR95D1',
    CROWN_DAY_92_VOUCHER: 'CR92D1',
    CROWN_75_VOUCHER: 'CROWN',
    CROWN_DAY_90_VOUCHER: 'CR90D1',
    CROWN_3DAY_92_VOUCHER: 'CR92D3',
    CROWN_3DAY_90_VOUCHER: 'CR90D3',
    CROWN_WEEK_92_VOUCHER: 'CR92W',
    CROWN_WEEK_90_VOUCHER: 'CR90W',
    CROWN_MONTH_92_VOUCHER: 'CR92M',
